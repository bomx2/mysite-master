	...
	<div id="container">
		...
		<div id="content">
			...
			<input type="hidden" name="a" value="update">
				<input type="hidden" value="${reading.no}" id="no" name="no">
				<input type="hidden" value="${reading.date}" id="date" name="date">
				...
				<table>
					<tr>
						...
						<td><input type="text" size="48" id="title" name="title" value="${reading.title}"></td>
					</tr>
					<tbody>
						<tr>
							<th scope="col" width="30%">내&nbsp;&nbsp;&nbsp;용</th>
							<td><textarea cols="50" rows="20" id="content" name="content" >${reading.content}</textarea></td>
						</tr>
					</tbody>
				</table>
					<button
